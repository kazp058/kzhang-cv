...
export default function PresentationLayout({ currentSection }) {
  ...
  return (
    <section className="relative h-screen w-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        <source src="https://resources.marketing-websites.pulselive.com/sony-sports/document/2024/09/06/cb60df61-fd21-4c4d-afec-ce9925034844/officiating-16mb.mp4" type="video/mp4" />
